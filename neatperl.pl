...
# 0.3  2019/08/30  BEZROUN    logic improved based on experince with writing neatperl
...
# INTERESTING, VERY NEAT IDEA: you can switch on tracing from particular line of source ( -1 to disable)
   ...
   banner($LOG_DIR,$main::SCRIPT_NAME,'Simple Perl prettyprinter',30); # Opens SYSLOG and print STDERRs banner; parameter 4 is log retention period
